...
export const MIGRATIONS: readonly string[] = [
  ...
  '0067_a_budget_this_agent_runs_under',
  '0068_when_it_was_actually_decided',
  '0069_an_audit_log_somebody_can_read',
  '0070_who_was_actually_in_the_room',
  '0071_an_approval_somebody_handed_on',
  '0072_an_insight_you_can_put_off',
  '0073_a_mailbox_somebody_connected',
  '0074_a_file_somebody_attached',
  '0075_a_plan_somebody_can_change',
  '0076_somebody_who_signed_in_with_the_directory',
  '0077_a_scan_that_was_written_down',
  '0078_a_workflow_that_runs_when_something_happens',
]
